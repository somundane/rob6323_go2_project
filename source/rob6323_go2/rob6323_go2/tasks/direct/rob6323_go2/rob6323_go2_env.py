...
class Rob6323Go2Env(DirectRLEnv):
    ...
    def _get_rewards(self) -> torch.Tensor:
        ...
        # Part 6 implementation for advanced foot interaction - Foot clearance and Contact Forces
        ...
        rewards = {
            ...
            "foot_clearance": rew_feet_clearance * self.cfg.feet_clearance_reward_scale,
            "contact_force": rew_tracking_contacts_shaped_force * self.cfg.contact_force_reward_scale,
        }
